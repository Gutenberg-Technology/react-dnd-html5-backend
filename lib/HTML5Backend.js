...
var _lodash_arrayIncludes = require('lodash/_arrayIncludes');

var _lodash_arrayIncludes2 = _interopRequireDefault(_lodash_arrayIncludes);
...
var HTML5Backend = (function () {
  ...
  HTML5Backend.prototype._getTargets = function _getTargets() {
    var elements = document.querySelectorAll('[data-draggable="true"]');
    var targets = [];
    for (var i in elements) {
      var element = elements[i];
      if (element.contentWindow) {
        if (!_lodash_arrayIncludes2['default'](targets, element.contentWindow)) {
          targets.push(element.contentWindow);
        }
      } else {
        if (!_lodash_arrayIncludes2['default'](targets, window)) {
          targets.push(window);
        }
      }
    }
